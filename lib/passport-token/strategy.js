...
function Strategy(options, verify) {
  ...
  this._tokenHeader    = options.tokenHeader ? options.tokenHeader.toLowerCase()    : 'Authorization';
  
  this._usernameField = options.usernameField ? options.usernameField.toLowerCase() : 'username';
  this._tokenField    = options.tokenField ? options.tokenField.toLowerCase()    : 'authentication_token';
...
Strategy.prototype.authenticate = function(req, options) {
  ...
  var token    = req.headers.authorization || lookup(req.body, this._tokenField) || lookup(req.query, this._tokenQuery);
